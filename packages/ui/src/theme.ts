...
:host {
  /* ─── Brand identity ──────────────────────────────────────────────── */
  --onegov-color-primary: #1a4598;
  --onegov-color-primary-hover: #153a82;
  --onegov-color-primary-active: #102d68;
  --onegov-color-primary-soft: #e9eefb;
  --onegov-color-primary-contrast: #ffffff;
  --onegov-color-accent: #ffcd00;
  --onegov-color-accent-hover: #ffd633;
  --onegov-color-accent-active: #e8b900;
  --onegov-color-accent-soft: #fff7cc;
  --onegov-color-accent-contrast: #0b1320;

  /* ─── Surface tokens ──────────────────────────────────────────────── */
  --onegov-color-bg: #ffffff;
  --onegov-color-surface: #f5f6fa;
  --onegov-color-surface-elevated: #ffffff;
  --onegov-color-surface-sunken: #eceff7;
  ...
  /* ─── Links ───────────────────────────────────────────────────────── */
  --onegov-color-link: #1a4598;
  --onegov-color-link-hover: #153a82;
  --onegov-color-link-visited: #5b3a8a;

  /* ─── Status colors ───────────────────────────────────────────────── */
  --onegov-color-danger: #c8102e;
  --onegov-color-danger-hover: #9f0d25;
  --onegov-color-danger-soft: #fde8ec;
  ...
  /* ─── Focus / accessibility ───────────────────────────────────────── */
  --onegov-focus-ring: 2px solid #1a4598;
  --onegov-focus-ring-color: #1a4598;
...
.onegov-card {
  border: 1px solid rgba(26, 69, 152, 0.1);
  border-radius: var(--onegov-radius-large);
  padding: var(--onegov-sp-6);
  background: var(--onegov-color-surface-elevated);
  box-shadow: 0 10px 28px rgba(16, 45, 104, 0.08);
  margin: 0 0 var(--onegov-spacing-2x);
  color: var(--onegov-color-text);
  transition:
    border-color var(--onegov-duration-base) var(--onegov-ease-standard),
    box-shadow var(--onegov-duration-base) var(--onegov-ease-standard),
    transform var(--onegov-duration-base) var(--onegov-ease-standard);
}
.onegov-card__title {
...
.onegov-card--premium {
  border: 1px solid rgba(26, 69, 152, 0.12);
  border-radius: var(--onegov-radius-large);
  padding: var(--onegov-sp-7);
  background: var(--onegov-color-surface-elevated);
  box-shadow: 0 12px 34px rgba(16, 45, 104, 0.1);
  margin: 0 0 var(--onegov-sp-5);
}
.onegov-card--premium:hover {
  border-color: rgba(26, 69, 152, 0.2);
  box-shadow: 0 16px 42px rgba(16, 45, 104, 0.14);
}
...
.onegov-card--interactive:hover {
  ...
  box-shadow: 0 16px 42px rgba(16, 45, 104, 0.14);
  border-color: rgba(26, 69, 152, 0.22);
}
.onegov-card--interactive:active {
  transform: translateY(0) scale(0.99);
  box-shadow: 0 8px 24px rgba(16, 45, 104, 0.1);
}
...
.onegov-card__header {
  ...
  border-bottom: 1px solid rgba(26, 69, 152, 0.08);
}
.onegov-card__footer {
  padding: var(--onegov-sp-4) var(--onegov-sp-5);
  border-top: 1px solid rgba(26, 69, 152, 0.08);
  background: var(--onegov-color-surface);
}
.onegov-card__icon {
  display: inline-flex;
  ...
  box-shadow: 0 8px 20px rgba(26, 69, 152, 0.18);
}
...
.onegov-modal--danger,
.onegov-modal--error {
  border: 1px solid var(--onegov-color-danger-soft);
}
.onegov-modal--danger .onegov-modal__title,
.onegov-modal--error .onegov-modal__title {
  color: var(--onegov-color-danger);
}
...
.onegov-accordion-item__trigger--open {
  background: var(--onegov-color-surface);
}
...
.onegov-accordion-item__panel {
  ...
  opacity: 0;
  transition:
    grid-template-rows var(--onegov-duration-300) var(--onegov-ease-emphasized),
    opacity var(--onegov-duration-base) var(--onegov-ease-standard);
}
.onegov-accordion-item__panel--open {
  grid-template-rows: 1fr;
  opacity: 1;
}
.onegov-accordion-item__panel-inner {
  min-height: 0;
  overflow: hidden;
  padding: 0 var(--onegov-sp-5);
  transition: padding var(--onegov-duration-300) var(--onegov-ease-emphasized);
}
.onegov-accordion-item__panel--open .onegov-accordion-item__panel-inner {
